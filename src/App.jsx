    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 pb-20">
      ...
      <div className="bg-indigo-900 pt-20 pb-28 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-indigo-100 text-xl font-medium opacity-90 max-w-xs mx-auto leading-relaxed">
      ...
      <div className="max-w-md mx-auto px-6 -mt-16 relative z-20">
        <div className="space-y-6">
          {contents.map((item) => (
            <a
              ...
              className="group bg-white rounded-[2.5rem] p-7 custom-shadow border border-white hover:translate-y-[-5px] active:scale-95 transition-all flex flex-col"
            >
              ...
              <div className="mt-auto flex items-center justify-between">
                <span className="text-indigo-600 font-black flex items-center gap-2">
                  지금 바로 시작하기 <MousePointer2 className="w-5 h-5 animate-bounce" />
                </span>
        ...
        {/* 하단 인스타그램 커뮤니티 섹션 */}
        <div className="mt-12 bg-slate-900 rounded-[3rem] p-10 text-center shadow-2xl border border-slate-800">
          ...
          <button
            ...
            className="w-full py-6 bg-indigo-600 text-white rounded-3xl font-black text-2xl hover:bg-indigo-500 transition-all active:scale-95 shadow-[0_15px_30px_rgba(79,70,229,0.4)] flex items-center justify-center gap-3"
          >
