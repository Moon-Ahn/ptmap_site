        ...
        {step === 'start' && (
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-gradient-to-b from-indigo-50 to-white">
            ...
            <button
              ...
              className="relative z-50 w-full py-5 bg-indigo-800 text-white rounded-2xl font-bold text-xl shadow-lg active:scale-95 transition-all mb-8 text-center cursor-pointer"
            >
              테스트 시작하기
            </button>
            {/* 시작 화면 광고 (320x50) */}
